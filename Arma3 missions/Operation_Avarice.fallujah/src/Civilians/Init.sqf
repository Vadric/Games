call compile preprocessFileLineNumbers "src\Civilians\Common\Common.sqf";
call compile preprocessFileLineNumbers "src\Civilians\Common\Debug.sqf";
...
if (isServer) then {
	call compile preprocessFileLineNumbers "src\Civilians\Server\ServerFunctions.sqf";
	call compile preprocessFileLineNumbers "src\Civilians\ConfigAndStart.sqf";
};
